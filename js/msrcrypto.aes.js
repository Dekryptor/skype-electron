...
//
//*******************************************************************************
var mscrypto = function () {

    var msrCryptoVersion = "1.3";
    var msrCrypto = msrCrypto || (function () {
        ...
        function initScriptBlob() {
            if (!scriptBlob) {
                scriptBlob = new Blob(['alert("not supported")']);
                scriptBlobUrl = window.URL.createObjectURL(scriptBlob);
            }
        }
        ...
        var webWorkerSupport = false; //(typeof Worker !== "undefined");

        // Is this script running in an instance of a webWorker?
        var runningInWorkerInstance = false; //(typeof importScripts !== "undefined");
